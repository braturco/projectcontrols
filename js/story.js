  ...
  beats: [
    {
      ...
      scenes: [
        {
          type: 'prose',
          html: 'This story will follow the path of a new Project Controller through the life cycle of a simulated project.',
        },
        {
          type: 'sms-card',
          alertType: 'phone',
          contact: {
            avatar: 'SC',
            name: 'Sarah Chen',
            sub: 'Project Manager · Kelowna BC',
          },
          messages: [
            {
              dir: 'received',
              text: 'Hey Jamie, hope all is well!  Remember that stretch goal we set last year around your interest in project control?',
              time: 'Sarah · Fri 7:22 PM',
            },
            {
              dir: 'sent',
              text: 'Yes of course!  Found a project I could handle?',
              time: 'Jamie · Fri 7:30 PM',
            },
            {
              dir: 'received',
              text: 'Yup!  We just landed Cascadia.  Dan is tied up on another job, but said this one would be perfect for you.',
              time: 'Sarah · Fri 7:31 PM',
            },
            {
              dir: 'received',
              text: 'We can chat Monday, just figured I would share the good news.  Have a great weekend.',
              time: 'Sarah · Fri 7:32 PM',
            },
          ],
        },
        {
          type: 'inner-voice',
          label: 'Jamie\'s Thinking',
          paragraphs: [
            'Jamies head was racing, this had always been a goal of his since he started with Ridgeline. The company had sent him on some training last year on Project Controls, he wonders if he can find his notes?',
          ],
        },
        {
          type: 'realbinder',
